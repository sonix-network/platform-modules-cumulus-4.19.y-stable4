/*
 * CPLD sysfs driver for quanta_ly7.
 *
...
#define DRIVER_NAME "quanta_ly7_cpld"
...
struct quanta_ly7_bde_platform_data {
	int idx;
};
...
struct port_status {
	char name[QUANTA_LY7_CPLD_STRING_NAME_SIZE];
	u8 index;
	u8 active_low;
	/*
	...
	u8 num_bits;
	u8 num_reg;
	u8 reg[QUANTA_LY7_REG_MAX];
};

static struct port_status sfp_status[] = {
	{
		.name = "present",
		...
		.num_bits = 16,
		.num_reg = 4,
		.reg = { LY7_IO_SFP_1_4_INFO_REG,
			 LY7_IO_SFP_5_8_INFO_REG,
			 LY7_IO_SFP_9_12_INFO_REG,
			 LY7_IO_SFP_13_16_INFO_REG},
	},
	{
		.name = "tx_fault",
			 ...
			 char *buf)
{
	...
	num_platform_status = ARRAY_SIZE(sfp_status);

	sensor_dev_attr = to_sensor_dev_attr(dattr);
	/* find the target register */
	target = &sfp_status[sensor_dev_attr->index];
	if (!target)
		return -EINVAL;
...
static SENSOR_DEVICE_ATTR_RO(sfp_1_16_present,     port_show,             0);
static SENSOR_DEVICE_ATTR_RO(sfp_1_16_tx_fault,    port_show,             1);
static SENSOR_DEVICE_ATTR_RW(sfp_1_16_tx_disable,  port_show, port_store, 2);
static SENSOR_DEVICE_ATTR_RO(sfp_1_16_rx_los,      port_show,             3);
static SENSOR_DEVICE_ATTR_RO(sfp_17_32_present,    port_show,             0);
static SENSOR_DEVICE_ATTR_RO(sfp_17_32_tx_fault,   port_show,             1);
static SENSOR_DEVICE_ATTR_RW(sfp_17_32_tx_disable, port_show, port_store, 2);
static SENSOR_DEVICE_ATTR_RO(sfp_17_32_rx_los,     port_show,             3);
static SENSOR_DEVICE_ATTR_RO(sfp_33_48_present,    port_show,             0);
static SENSOR_DEVICE_ATTR_RO(sfp_33_48_tx_fault,   port_show,             1);
static SENSOR_DEVICE_ATTR_RW(sfp_33_48_tx_disable, port_show, port_store, 2);
static SENSOR_DEVICE_ATTR_RO(sfp_33_48_rx_los,     port_show,             3);
			...
			char *buf)
{
	...
	retval = cpld_port_reg_byte_read(client, LY7_LED_DECODER_REG, &val);
			 ...
			 const char *buf, size_t count)
{
	...
	retval = cpld_port_reg_byte_write(client, LY7_LED_DECODER_REG, val);
	if (retval < 0)
		return retval;
...
static SYSFS_ATTR_RW(led_decoder, led_show, led_store);
...
static struct attribute *sfp_1_16_attrs[] = {
	&sensor_dev_attr_sfp_1_16_present.dev_attr.attr,
	&sensor_dev_attr_sfp_1_16_tx_fault.dev_attr.attr,
	&sensor_dev_attr_sfp_1_16_tx_disable.dev_attr.attr,
	&sensor_dev_attr_sfp_1_16_rx_los.dev_attr.attr,
	NULL,
};

static struct attribute *sfp_17_32_attrs[] = {
	&sensor_dev_attr_sfp_17_32_present.dev_attr.attr,
	&sensor_dev_attr_sfp_17_32_tx_fault.dev_attr.attr,
	&sensor_dev_attr_sfp_17_32_tx_disable.dev_attr.attr,
	&sensor_dev_attr_sfp_17_32_rx_los.dev_attr.attr,
	NULL,
};

static struct attribute *sfp_33_48_attrs[] = {
	&sensor_dev_attr_sfp_33_48_present.dev_attr.attr,
	&sensor_dev_attr_sfp_33_48_tx_fault.dev_attr.attr,
	&sensor_dev_attr_sfp_33_48_tx_disable.dev_attr.attr,
	&sensor_dev_attr_sfp_33_48_rx_los.dev_attr.attr,
	NULL,
};

static struct attribute *led_attrs[] = {
	&dev_attr_led_decoder.attr,
	NULL,
};

static struct attribute_group sfp_1_16_attr_group = {
	.attrs = sfp_1_16_attrs,
};

static struct attribute_group sfp_33_48_attr_group = {
	.attrs = sfp_33_48_attrs,
};

static struct attribute_group sfp_17_32_attr_group = {
	.attrs = sfp_17_32_attrs,
};
...
{
	struct quanta_ly7_bde_platform_data *pdata;
	int retval;
	int cpld_idx;
	 ...
	 */
	switch (cpld_idx) {
	case LY7_IO_SFP28_33_48_CPLD_ID:
		retval = sysfs_create_group(kobj,
					    &sfp_33_48_attr_group);
		break;
	case LY7_IO_SFP28_1_16_CPLD_ID:
		retval = sysfs_create_group(kobj,
					    &sfp_1_16_attr_group);
		break;
	case LY7_IO_SFP28_17_32_CPLD_ID:
		retval = sysfs_create_group(kobj,
					    &sfp_17_32_attr_group);
		break;
	case LY7_LED_CPLD_ID:
		retval = sysfs_create_group(kobj,
					    &led_attr_group);
		break;
...
static int cpld_remove(struct i2c_client *client)
{
	...
	sysfs_remove_group(kobj, &led_attr_group);
	sysfs_remove_group(kobj, &sfp_33_48_attr_group);
	sysfs_remove_group(kobj, &sfp_17_32_attr_group);
	sysfs_remove_group(kobj, &sfp_1_16_attr_group);
...
static int __init quanta_ly7_cpld_init(void)
{
	int rv;
...
static void __exit quanta_ly7_cpld_exit(void)
{
...
MODULE_DESCRIPTION("CPLD driver for Quanta LY7 Platform");
MODULE_LICENSE("GPL");
MODULE_VERSION(DRIVER_VERSION);

module_init(quanta_ly7_cpld_init);
module_exit(quanta_ly7_cpld_exit);

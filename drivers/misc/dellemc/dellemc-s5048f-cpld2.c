...
#define DRIVER_NAME    S5048F_CPLD2_NAME
			 ...
			 u32 *val)
{
	...
	if (ret < 0) {
		dev_err(dev, "CPLD2 read error - reg: 0x%02x\n", reg);
		return -EINVAL;
	}
	*val = ret;
	return 0;
			...
			char *buf)
{
	...
	for (i = 0; i < NUM_CPLD2_SFP28_REGS; i++) {
...
static SENSOR_DEVICE_ATTR_RW(sfp28_20_1_tx_disable,   sfp_show, sfp_store, 0);
static SENSOR_DEVICE_ATTR_RW(sfp28_20_1_rx_ctrl0,     sfp_show, sfp_store, 1);
static SENSOR_DEVICE_ATTR_RO(sfp28_20_1_rx_los,	      sfp_show, 2);
static SENSOR_DEVICE_ATTR_RO(sfp28_20_1_tx_fault,     sfp_show, 3);
static SENSOR_DEVICE_ATTR_RO(sfp28_20_1_present,      sfp_show, 4);
static SENSOR_DEVICE_ATTR_RO(sfp28_20_1_rx_los_int,   sfp_show, 5);
static SENSOR_DEVICE_ATTR_RO(sfp28_20_1_present_int,  sfp_show, 6);
static SENSOR_DEVICE_ATTR_RW(sfp28_20_1_rx_los_mask,  sfp_show, sfp_store, 7);
static SENSOR_DEVICE_ATTR_RW(sfp28_20_1_present_mask, sfp_show, sfp_store, 8);
...
static struct attribute *cpld_attrs[] = {
	...
	&sensor_dev_attr_sfp28_20_1_tx_disable.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_rx_ctrl0.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_rx_los.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_tx_fault.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_present.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_rx_los_int.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_present_int.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_rx_los_mask.dev_attr.attr,
	&sensor_dev_attr_sfp28_20_1_present_mask.dev_attr.attr,
...
static int cpld_probe(struct i2c_client *client)
{
	...
	/* all clear */
	dev_info(dev, "device probed, CPLD2 rev: %lu.%lu\n",
...
MODULE_DESCRIPTION("Dell EMC S5048F CPLD2 Driver");

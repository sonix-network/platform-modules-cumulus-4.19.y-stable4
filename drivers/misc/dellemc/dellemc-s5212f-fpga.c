...
/*
 * Dell EMC S5212F-C3538 FPGA Driver
 *
...
#define DRIVER_NAME		  "dellemc_s5212f_fpga"
...
enum {
	FPGA_I2C_CH1 = 5, /* SW_CPLD */
	FPGA_I2C_CH2,
	FPGA_I2C_CH3,
	FPGA_I2C_CH4,	/*  SFP28_1  -	SFP28_8	  */
	FPGA_I2C_CH5,	/*  SFP28_9  -	SFP28_12, QSFP_1 - QSFP_3  */
	FPGA_I2C_CH6,
	FPGA_I2C_CH7,
	FPGA_I2C_CH8,
	FPGA_I2C_CH9,
...
static struct platform_i2c_device_info fpga_i2c_devices[] = {
	...
	mk_i2cdev(FPGA_I2C_CH5_MUX_BUS4, "sff8436", 0x50, &port13_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH5_MUX_BUS5, "sff8436", 0x50, &port14_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH5_MUX_BUS6, "sff8436", 0x50, &port15_50_sff8436),
};
...
/*
 * The Dell S5212F has register blocks allocated to manage 16 FPGA I2C busses
 * I2C1-I2C16 using:
 *
...
static int fpga_probe(struct pci_dev *pdev, const struct pci_device_id *devid)
{
	 ...
	 * Everything else can be added from dellemc_s5212f_init() afterward.
	 *
...
static int __init dellemc_s5212f_init(void)
{
	int ret;
...
static void __exit dellemc_s5212f_exit(void)
{
	fpga_exit();
	pr_info(DRIVER_NAME ": driver successfully unloaded\n");
}

module_init(dellemc_s5212f_init);
module_exit(dellemc_s5212f_exit);

MODULE_AUTHOR("David Yen (dhyen@cumulusnetworks.com)");
MODULE_DESCRIPTION("Dell EMC S5212F Platform Support");

...
#define DRIVER_NAME         AG9032V1_FANMUX_NAME
#define DRIVER_VERSION      "1.1"
#define MUX_INVALID_CHANNEL 0x0
#define MUX_NUM_PORTS       8
#define MUX_SELECT_REG      DELTA_AG9032V1_SWCPLD_PSU_AND_FAN_I2C_MUX_REG
#define MUX_SELECT_MSB      DELTA_AG9032V1_FAN_I2C_SEL_MSB
#define MUX_SELECT_LSB      DELTA_AG9032V1_FAN_I2C_SEL_LSB
#define MUX_FIRST_BUS_NUM   CPLD_FAN_MUX_BUS0
...
MODULE_DESCRIPTION("Delta AG9032v1 Fan Mux Driver");

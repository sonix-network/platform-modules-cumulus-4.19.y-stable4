/*
 * Celestica Seastone2 FPGA Support
 *
...
#define DRIVER_NAME	"cel_seastone2_fpga"
...
#define FIRST_QSFP_PORT		     1
#define NUM_QSFP_PORTS		     32
#define CPLD1_MAX_PORT		     16
#define CPLD2_MAX_PORT		     32
...
enum {
	...
	FPGA_I2C_CH2_MUX1_BUS0,
	FPGA_I2C_CH2_MUX1_BUS1,
	FPGA_I2C_CH2_MUX1_BUS2,
	FPGA_I2C_CH2_MUX1_BUS3,
	FPGA_I2C_CH2_MUX1_BUS4,
	FPGA_I2C_CH2_MUX1_BUS5,
	FPGA_I2C_CH2_MUX1_BUS6,
	FPGA_I2C_CH2_MUX1_BUS7,

	FPGA_I2C_CH2_MUX2_BUS0,
	FPGA_I2C_CH2_MUX2_BUS1,
	FPGA_I2C_CH2_MUX2_BUS2,
	FPGA_I2C_CH2_MUX2_BUS3,
	FPGA_I2C_CH2_MUX2_BUS4,
	FPGA_I2C_CH2_MUX2_BUS5,
	FPGA_I2C_CH2_MUX2_BUS6,
	FPGA_I2C_CH2_MUX2_BUS7,

	FPGA_I2C_CH2_MUX3_BUS0,
	FPGA_I2C_CH2_MUX3_BUS1,
	FPGA_I2C_CH2_MUX3_BUS2,
	FPGA_I2C_CH2_MUX3_BUS3,
	FPGA_I2C_CH2_MUX3_BUS4,
	FPGA_I2C_CH2_MUX3_BUS5,
	FPGA_I2C_CH2_MUX3_BUS6,
	FPGA_I2C_CH2_MUX3_BUS7,
};
...
mk_pca9548(fpga_ch2_mux0, FPGA_I2C_CH2_MUX0_BUS0, 1);
mk_pca9548(fpga_ch2_mux1, FPGA_I2C_CH2_MUX1_BUS0, 1);
mk_pca9548(fpga_ch2_mux2, FPGA_I2C_CH2_MUX2_BUS0, 1);
mk_pca9548(fpga_ch2_mux3, FPGA_I2C_CH2_MUX3_BUS0, 1);
...
static struct platform_i2c_device_info fpga_i2c_devices[] = {
	mk_i2cdev(FPGA_I2C_CH2, "pca9548", 0x72, &fpga_ch2_mux0_platform_data),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS0, "sff8436", 0x50, &port1_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS1, "sff8436", 0x50, &port2_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS2, "sff8436", 0x50, &port3_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS3, "sff8436", 0x50, &port4_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS4, "sff8436", 0x50, &port5_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS5, "sff8436", 0x50, &port6_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS6, "sff8436", 0x50, &port7_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX0_BUS7, "sff8436", 0x50, &port8_50_sff8436),

	mk_i2cdev(FPGA_I2C_CH2, "pca9548", 0x73, &fpga_ch2_mux1_platform_data),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS0, "sff8436", 0x50, &port9_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS1, "sff8436", 0x50, &port10_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS2, "sff8436", 0x50, &port11_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS3, "sff8436", 0x50, &port12_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS4, "sff8436", 0x50, &port13_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS5, "sff8436", 0x50, &port14_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS6, "sff8436", 0x50, &port15_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX1_BUS7, "sff8436", 0x50, &port16_50_sff8436),

	mk_i2cdev(FPGA_I2C_CH2, "pca9548", 0x74, &fpga_ch2_mux2_platform_data),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS0, "sff8436", 0x50, &port17_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS1, "sff8436", 0x50, &port18_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS2, "sff8436", 0x50, &port19_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS3, "sff8436", 0x50, &port20_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS4, "sff8436", 0x50, &port21_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS5, "sff8436", 0x50, &port22_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS6, "sff8436", 0x50, &port23_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX2_BUS7, "sff8436", 0x50, &port24_50_sff8436),

	mk_i2cdev(FPGA_I2C_CH2, "pca9548", 0x75, &fpga_ch2_mux3_platform_data),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS0, "sff8436", 0x50, &port25_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS1, "sff8436", 0x50, &port26_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS2, "sff8436", 0x50, &port27_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS3, "sff8436", 0x50, &port28_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS4, "sff8436", 0x50, &port29_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS5, "sff8436", 0x50, &port30_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS6, "sff8436", 0x50, &port31_50_sff8436),
	mk_i2cdev(FPGA_I2C_CH2_MUX3_BUS7, "sff8436", 0x50, &port32_50_sff8436),

	mk_i2cdev(FPGA_I2C_CH3, "cel_seastone2_cpld", 0x30, NULL),
	mk_i2cdev(FPGA_I2C_CH3, "cel_seastone2_cpld", 0x31, NULL),
};
...
static struct attribute *fpga_attrs[] = {
	fpga_qsfp_port_attrs(1),
	fpga_qsfp_port_attrs(2),
	fpga_qsfp_port_attrs(3),
	fpga_qsfp_port_attrs(4),
	fpga_qsfp_port_attrs(5),
	fpga_qsfp_port_attrs(6),
	fpga_qsfp_port_attrs(7),
	fpga_qsfp_port_attrs(8),
	fpga_qsfp_port_attrs(9),
	fpga_qsfp_port_attrs(10),
	fpga_qsfp_port_attrs(11),
	fpga_qsfp_port_attrs(12),
	fpga_qsfp_port_attrs(13),
	fpga_qsfp_port_attrs(14),
	fpga_qsfp_port_attrs(15),
	fpga_qsfp_port_attrs(16),
	fpga_qsfp_port_attrs(17),
	fpga_qsfp_port_attrs(18),
	fpga_qsfp_port_attrs(19),
	fpga_qsfp_port_attrs(20),
	fpga_qsfp_port_attrs(21),
	fpga_qsfp_port_attrs(22),
	fpga_qsfp_port_attrs(23),
	fpga_qsfp_port_attrs(24),
	fpga_qsfp_port_attrs(25),
	fpga_qsfp_port_attrs(26),
	fpga_qsfp_port_attrs(27),
	fpga_qsfp_port_attrs(28),
	fpga_qsfp_port_attrs(29),
	fpga_qsfp_port_attrs(30),
	fpga_qsfp_port_attrs(31),
	fpga_qsfp_port_attrs(32),
...
static int fpga_probe(struct pci_dev *pdev, const struct pci_device_id *devid)
{
	...
	if (err) {
		pr_err(DRIVER_NAME ": sysfs_fpga_attr_group failed for FPGA misc registers\n");
	 ...
	 * FPGA I2C_CH2	 gets start 0x200, end 0x2ff
	 * ...
...
static struct platform_driver cpld_driver = {
	.driver = {
		.name = "cel_sea2_switch_board_cpld",
		.owner = THIS_MODULE,
	},
	.probe = cpld_probe,
	.remove = cpld_remove,
...
static int cpld_init(void)
{
	...
	cpld_device = platform_device_alloc("cel_sea2_switch_board_cpld", 0);
	if (!cpld_device) {
...
static int __init cel_seastone2_init(void)
{
	int ret;
...
static void __exit cel_seastone2_exit(void)
{
	cpld_exit();
	fpga_exit();
...
module_init(cel_seastone2_init);
module_exit(cel_seastone2_exit);

MODULE_AUTHOR("David Yen (dhyen@cumulusnetworks.com)");
MODULE_DESCRIPTION("Celestica Seastone2 FPGA Driver");

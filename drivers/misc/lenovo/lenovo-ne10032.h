...
/*
 * Lenovo NE10032 Platform Definitions
 *
...
#ifndef LENOVO_NE10032_H__
#define LENOVO_NE10032_H__

#define MUX_NAME_LEN                 (32)
#define NUM_PORTS                    (32)
#define NUM_PORT_MUXES               (4)

/* The Lenovo NE10032 actually has seven CPLDs: Master, Power, System, and
 * four Port CPLDs.  The CPLD driver has been coded such that we have the
...
#define   SYSTEM_BCM56960_RESET_MASK               (0x20)
#define   SYSTEM_BCM56960_RESET_SHIFT              (5)
...
#define   SYSTEM_PORT_CPLD3_RESET_MASK             (0x08)
#define   SYSTEM_PORT_CPLD3_RESET_SHIFT            (3)
...
#define   SYSTEM_FAN2_LED_COLOR_MASK               (0x40)
#define   SYSTEM_FAN2_LED_AMBER                    (0x00)
#define   SYSTEM_FAN2_LED_GREEN                    (0x40)
#define   SYSTEM_FAN2_LED_COLOR_SHIFT              (6)
#define   SYSTEM_FAN2_LED_MASK                     (0x30)
#define   SYSTEM_FAN2_LED_OFF                      (0x00)
#define   SYSTEM_FAN2_LED_ON                       (0x10)
#define   SYSTEM_FAN2_LED_SLOW_BLINKING            (0x20)
#define   SYSTEM_FAN2_LED_FAST_BLINKING            (0x30)
#define   SYSTEM_FAN2_LED_SHIFT                    (4)
#define   SYSTEM_FAN1_LED_COLOR_MASK               (0x04)
#define   SYSTEM_FAN1_LED_AMBER                    (0x00)
#define   SYSTEM_FAN1_LED_GREEN                    (0x04)
#define   SYSTEM_FAN1_LED_COLOR_SHIFT              (2)
#define   SYSTEM_FAN1_LED_MASK                     (0x03)
#define   SYSTEM_FAN1_LED_OFF                      (0x00)
#define   SYSTEM_FAN1_LED_ON                       (0x01)
#define   SYSTEM_FAN1_LED_SLOW_BLINKING            (0x02)
#define   SYSTEM_FAN1_LED_FAST_BLINKING            (0x03)

#define SYSTEM_FAN_1_LED_REG                       (0x0A | SYSTEM_CPLD_IDX)
#define   SYSTEM_FAN4_LED_COLOR_MASK               (0x40)
#define   SYSTEM_FAN4_LED_AMBER                    (0x00)
#define   SYSTEM_FAN4_LED_GREEN                    (0x40)
#define   SYSTEM_FAN4_LED_COLOR_SHIFT              (6)
#define   SYSTEM_FAN4_LED_MASK                     (0x30)
#define   SYSTEM_FAN4_LED_OFF                      (0x00)
#define   SYSTEM_FAN4_LED_ON                       (0x10)
#define   SYSTEM_FAN4_LED_SLOW_BLINKING            (0x20)
#define   SYSTEM_FAN4_LED_FAST_BLINKING            (0x30)
#define   SYSTEM_FAN4_LED_SHIFT                    (4)
#define   SYSTEM_FAN3_LED_COLOR_MASK               (0x04)
#define   SYSTEM_FAN3_LED_AMBER                    (0x00)
#define   SYSTEM_FAN3_LED_GREEN                    (0x04)
#define   SYSTEM_FAN3_LED_COLOR_SHIFT              (2)
#define   SYSTEM_FAN3_LED_MASK                     (0x03)
#define   SYSTEM_FAN3_LED_OFF                      (0x00)
#define   SYSTEM_FAN3_LED_ON                       (0x01)
#define   SYSTEM_FAN3_LED_SLOW_BLINKING            (0x02)
#define   SYSTEM_FAN3_LED_FAST_BLINKING            (0x03)

#define SYSTEM_FAN_2_LED_REG                       (0x0B | SYSTEM_CPLD_IDX)
#define   SYSTEM_FAN6_LED_COLOR_MASK               (0x40)
#define   SYSTEM_FAN6_LED_AMBER                    (0x00)
#define   SYSTEM_FAN6_LED_GREEN                    (0x40)
#define   SYSTEM_FAN6_LED_COLOR_SHIFT              (6)
#define   SYSTEM_FAN6_LED_MASK                     (0x30)
#define   SYSTEM_FAN6_LED_OFF                      (0x00)
#define   SYSTEM_FAN6_LED_ON                       (0x10)
#define   SYSTEM_FAN6_LED_SLOW_BLINKING            (0x20)
#define   SYSTEM_FAN6_LED_FAST_BLINKING            (0x30)
#define   SYSTEM_FAN6_LED_SHIFT                    (4)
#define   SYSTEM_FAN5_LED_COLOR_MASK               (0x04)
#define   SYSTEM_FAN5_LED_AMBER                    (0x00)
#define   SYSTEM_FAN5_LED_GREEN                    (0x04)
#define   SYSTEM_FAN5_LED_COLOR_SHIFT              (2)
#define   SYSTEM_FAN5_LED_MASK                     (0x03)
#define   SYSTEM_FAN5_LED_OFF                      (0x00)
#define   SYSTEM_FAN5_LED_ON                       (0x01)
#define   SYSTEM_FAN5_LED_SLOW_BLINKING            (0x02)
#define   SYSTEM_FAN5_LED_FAST_BLINKING            (0x03)
...
#define PORT_1_8_SELECT_RANGE                      (8)
#define PORT_CPLD0_REVISION_REG                    (0x00 | PORT_CPLD0_IDX)
#define PORT_QSFP28_1_8_INTERRUPT_REG              (0x01 | PORT_CPLD0_IDX)
#define PORT_QSFP28_1_8_PRESENT_REG                (0x05 | PORT_CPLD0_IDX)
#define PORT_QSFP28_1_8_RESET_REG                  (0x07 | PORT_CPLD0_IDX)
#define PORT_QSFP28_1_8_LPMODE_REG                 (0x09 | PORT_CPLD0_IDX)
#define PORT_QSFP28_1_8_MODSEL_REG                 (0x0B | PORT_CPLD0_IDX)

#define PORT_9_16_SELECT_RANGE                     (16)
#define PORT_CPLD1_REVISION_REG                    (0x00 | PORT_CPLD1_IDX)
#define PORT_QSFP28_9_16_INTERRUPT_REG             (0x01 | PORT_CPLD1_IDX)
#define PORT_QSFP28_9_16_PRESENT_REG               (0x05 | PORT_CPLD1_IDX)
#define PORT_QSFP28_9_16_RESET_REG                 (0x07 | PORT_CPLD1_IDX)
#define PORT_QSFP28_9_16_LPMODE_REG                (0x09 | PORT_CPLD1_IDX)
#define PORT_QSFP28_9_16_MODSEL_REG                (0x0B | PORT_CPLD1_IDX)

#define PORT_17_24_SELECT_RANGE                    (24)
#define PORT_CPLD2_REVISION_REG                    (0x00 | PORT_CPLD2_IDX)
#define PORT_QSFP28_17_24_INTERRUPT_REG            (0x01 | PORT_CPLD2_IDX)
#define PORT_QSFP28_17_24_PRESENT_REG              (0x05 | PORT_CPLD2_IDX)
#define PORT_QSFP28_17_24_RESET_REG                (0x07 | PORT_CPLD2_IDX)
#define PORT_QSFP28_17_24_LPMODE_REG               (0x09 | PORT_CPLD2_IDX)
#define PORT_QSFP28_17_24_MODSEL_REG               (0x0B | PORT_CPLD2_IDX)

#define PORT_25_32_SELECT_RANGE                    (32)
#define PORT_CPLD3_REVISION_REG                    (0x00 | PORT_CPLD3_IDX)
#define PORT_QSFP28_25_32_INTERRUPT_REG            (0x01 | PORT_CPLD3_IDX)
#define PORT_QSFP28_25_32_PRESENT_REG              (0x05 | PORT_CPLD3_IDX)
#define PORT_QSFP28_25_32_RESET_REG                (0x07 | PORT_CPLD3_IDX)
#define PORT_QSFP28_25_32_LPMODE_REG               (0x09 | PORT_CPLD3_IDX)
#define PORT_QSFP28_25_32_MODSEL_REG               (0x0B | PORT_CPLD3_IDX)

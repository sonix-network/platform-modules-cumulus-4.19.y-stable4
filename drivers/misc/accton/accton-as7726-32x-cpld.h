/*
 * Accton AS7726-32X CPLD Platform Definitions
 *
...
#ifndef ACCTON_7726_CPLD_H__
#define ACCTON_7726_CPLD_H__

#define SMB_I801_NAME "SMBus I801 adapter"
#define SMB_ISMT_NAME "SMBus iSMT adapter"
#define MAX_NUM_QSFP_REGS 4
#define ACCTON_AS7726_CPLD_STRING_NAME_SIZE     30
...
#define CPLD1_QSFP_1_8_RESET_REG                (0x04 | CPLD1_IDX)
#define CPLD1_QSFP_9_16_RESET_REG               (0x05 | CPLD1_IDX)
#define CPLD1_QSFP_17_24_RESET_REG              (0x06 | CPLD1_IDX)
#define CPLD1_QSFP_25_32_RESET_REG              (0x07 | CPLD1_IDX)
/* System reset registers */
#define CPLD1_SYSTEM_RESET_5_REG                (0x08 | CPLD1_IDX)
#define CPLD1_SYSTEM_RESET_6_REG                (0x09 | CPLD1_IDX)
#define CPLD1_SYSTEM_RESET_7_REG                (0x0a | CPLD1_IDX)
#define CPLD1_SYSTEM_RESET_LOCK_REG             (0x0b | CPLD1_IDX)
/* QSFP interrupt status registers */
#define CPLD1_QSFP_1_8_INTERRUPT_STATUS_REG     (0x10 | CPLD1_IDX)
#define CPLD1_QSFP_9_16_INTERRUPT_STATUS_REG    (0x11 | CPLD1_IDX)
#define CPLD1_QSFP_17_24_INTERRUPT_STATUS_REG   (0x12 | CPLD1_IDX)
#define CPLD1_QSFP_25_32_INTERRUPT_STATUS_REG   (0x13 | CPLD1_IDX)
/* System interrupt status registers */
#define CPLD1_INTERRUPT_STATUS_5_REG            (0x14 | CPLD1_IDX)
...
#define CPLD1_INTERRUPT_STATUS_FPGA             BIT(5)
#define CPLD1_INTERRUPT_STATUS_FAN              BIT(6)
#define CPLD1_INTERRUPT_STATUS_IDT8V89307       BIT(7)
#define CPLD1_INTERRUPT_STATUS_6_REG            (0x15 | CPLD1_IDX)
#define CPLD1_INTERRUPT_STATUS_MAC              BIT(0)
#define CPLD1_INTERRUPT_STATUS_MAC_PCIE         BIT(1)
/* QSFP interrupt mask registers */
#define CPLD1_QSFP_1_8_INTERRUPT_MASK_REG       (0x20 | CPLD1_IDX)
#define CPLD1_QSFP_9_16_INTERRUPT_MASK_REG      (0x21 | CPLD1_IDX)
#define CPLD1_QSFP_17_24_INTERRUPT_MASK_REG     (0x22 | CPLD1_IDX)
#define CPLD1_QSFP_25_32_INTERRUPT_MASK_REG     (0x23 | CPLD1_IDX)
/* System interrupt mask registers */
#define CPLD1_INTERRUPT_MASK_5_REG              (0x24 | CPLD1_IDX)
#define CPLD1_INTERRUPT_MASK_LM75_1             BIT(0)
#define CPLD1_INTERRUPT_MASK_LM75_2             BIT(1)
#define CPLD1_INTERRUPT_MASK_LM75_3             BIT(2)
#define CPLD1_INTERRUPT_MASK_CPLD_2             BIT(3)
#define CPLD1_INTERRUPT_MASK_CPLD_3             BIT(4)
#define CPLD1_INTERRUPT_MASK_FPGA               BIT(5)
#define CPLD1_INTERRUPT_MASK_FAN                BIT(6)
#define CPLD1_INTERRUPT_MASK_IDT8V89307         BIT(7)
#define CPLD1_INTERRUPT_MASK_6_REG              (0x25 | CPLD1_IDX)
#define CPLD1_INTERRUPT_MASK_MAC                BIT(0)
#define CPLD1_INTERRUPT_MASK_MAC_PCIE           BIT(1)
/* QSFP present registers */
#define CPLD1_QSFP_1_8_PRESENT_REG              (0x30 | CPLD1_IDX)
#define CPLD1_QSFP_9_16_PRESENT_REG             (0x31 | CPLD1_IDX)
#define CPLD1_QSFP_17_24_PRESENT_REG            (0x32 | CPLD1_IDX)
#define CPLD1_QSFP_25_32_PRESENT_REG            (0x33 | CPLD1_IDX)
/* System led definitions */
#define CPLD1_SYSTEM_LED_1_REG                  (0x41 | CPLD1_IDX)
#define CPLD1_LOC_LED_MASK                      (0x80)
#define CPLD1_LOC_BLUE_LED_OFF                  (0x80)
#define CPLD1_LOC_BLUE_LED_ON                   (0x00)
#define CPLD1_DIAG_LED_MASK                     (0x03)
#define CPLD1_DIAG_RED_LED_ON                   (0x01)
#define CPLD1_DIAG_LED_OFF                      (0x03)
#define CPLD1_DIAG_GREEN_LED_ON                 (0x02)
/*********************************************
